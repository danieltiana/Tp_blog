...
function List_Articles () {
  ...
  const Donnee =
    filtre === 'All'
      ? Donnees
      : Donnees.filter(d => d.categories.includes(filtre))
  ...
  return (
    <section className='bg-gradient-to-r from-black to-gray-900'>
      <Container>
        <div
          data-aos='fade-down'
          className='p-24  mb-4 text-white rounded bg-gray-900 h-150'
        >
          <div className='col-md-6 px-0'>
            <h1 className='display-4 text-warning font-italic'>
              Liste des blog
            </h1>
            ...
            <p className='lead text-secondary my-3'>
              Vous pouvez voir la liste des blog ici. Consultez par categories
            </p>
            <p className='lead mb-0'>
              <a className='text-secondary font-weight-bold text-decoration-none'>
                LEs nouveautés et dernieres actus de jeux vidéos <br /> sont
                tous ici
              </a>
            </p>
          </div>
        ...
        <div className='nav-scroller w-100 py-1 mb-2' style={{ width: '100%' }}>
          <nav
            ...
            style={{ width: '100%' }}
          >
            <span className='p2 btn btn-warning link-warning'>
              Categories:{' '}
            </span>
            <button
