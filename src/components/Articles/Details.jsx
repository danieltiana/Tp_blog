    ...
    return (
      <Container>
        <div className='flex items-center' style={{ height: '100vh' }}>
          <h2 className='text-center mb-5 font-bold bg-gradient-to-r from-blue-400 to-purple-400 text-transparent bg-clip-text text-5xl'>
            Article introuvable
          </h2>
          &nbsp;&nbsp;
          <button
    ...
    <section className='py-5 bg-transparent bg-gradient-to-r from-black to-gray-900 bg-opacity-50 opacity-0 transition-opacity-duration-1000 ease-out opacity-100'>
      <Container>
        <Row>
          ...
          <Card
            className='h-100 shadow-sm bg-gray-900 rounded text-light'
            style={{ marginTop: '55px' }}
          >
            <Card.Header className='text-dark text-align-left p-0 bg-transparent mt-5 mx-5'>
              <span className='badge bg-secondary text-light'>
                categorie : {DetailArticle.categories}
              </span>
            </Card.Header>
            <Card.Body className=''>
              <div>
                <Card.Img
                  variant='top'
                  className='border m-2 bg-dark'
                  style={{ height: '60vh', objectFit: 'cover' }}
                  src={`../../${DetailArticle.image}`}
                />
              </div>
              <Card.Title className='rounded border shadow p-3 text-center text-warning text-2xl'>
                {DetailArticle.titre}
              </Card.Title>
              <Card.Text className='p-5'>
                {DetailArticle.descriptions}
              </Card.Text>
      ...
      <h2
        data-aos='fade-down'
        className='text-center mb-5 font-bold bg-gradient-to-r from-blue-400 to-purple-400 text-transparent bg-clip-text text-5xl'
      >
