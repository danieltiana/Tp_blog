...
function NavigationBar () {
  ...
  return (
    ...
    >
      <div
        className={`${Scrolls == true ? 'container block-sm' : 'block w-100'}`}
      >
        <Nav
          className={`flex justify-center ${
            Scrolls == true && ecranSize <= 641 ? 'd-none' : ''
          }`}
        >
          <div
            className={`font-bold bg-gradient-to-r from-blue-400 to-purple-400 text-transparent bg-clip-text ${
              Scrolls == true ? 'text-2xl' : 'text-5xl p-3 h1'
            }`}
          >
        ...
        <Nav
          data-aos={`${Scrolls == true ? 'fade-down' : 'fade-down'}`}
          className=''
        >
